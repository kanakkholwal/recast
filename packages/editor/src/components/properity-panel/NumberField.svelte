...
<div
	class={cn(
		"flex h-8 min-w-0 items-center gap-1.5 rounded-md bg-muted/60 pl-2 pr-2 ring-1 ring-inset ring-border/40 transition-[background-color,box-shadow] hover:bg-muted focus-within:bg-card focus-within:ring-ring/60",
