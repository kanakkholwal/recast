...
export function defaultSpec(
	...
	const spec: SceneAnimSpec = {
		kind,
		durationMs: clampAnimMs(DEFAULT_ANIM_MS * tp.durationScale),
		easing,
	};
...
export function setSegmentAnim(
	...
	const rest = overrides.filter((o) => Math.abs(o.start - start) > EPS).map((o) => ({ ...o }));
