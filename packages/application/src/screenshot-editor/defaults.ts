...
import type { Frame, ImageFilters, ImageStyle, ImageStylePreset, Mockup, Shadow, ShadowPreset } from "./types";
...
/** Matches the clone's default shadowPreset ('soft'). */
...
export const DEFAULT_MOCKUP: Mockup = { kind: "none", theme: "light", url: "example.com" };
