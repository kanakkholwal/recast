...
<div
	class={cn(
		"bg-muted/60 ring-border/40 focus-within:bg-card focus-within:ring-ring/60 flex h-7 min-w-0 max-w-32 items-center gap-1.5 rounded-md pr-2 pl-2.5 ring-1 ring-inset transition-[background-color,box-shadow] hover:bg-muted",
...
>
	{#if Icon || glyph !== undefined}
		<span
			class="text-muted-foreground/80 flex shrink-0 cursor-ew-resize items-center justify-center touch-none select-none"
	...
	<input
		...
		onblur={commitTyped}
		onkeydown={onKeydown}
		class="text-foreground w-full min-w-0 bg-transparent font-mono text-[11px] tabular-nums focus:outline-none"
	/>
</div>
