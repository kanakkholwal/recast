...
<!--
AI accent: atom (Phosphor duotone).

Decorative / context cue rather than a specific AI action. Reserved for
places where we want the AI surface to feel "scientific" (annotation glow,
auto-captioned selections, etc.). Distinct from `AiWand` (which signals
"do this for me") — same dual tone, different semantics.
-->
<svg
