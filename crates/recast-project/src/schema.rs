...
fn camera_group() -> Vec<ElementSpec> {
    ...
    el(
        ...
        &[
            ...
            req("src", AttrType::Text, "Signal: time, cursor, click, zoom.center, audio.level, word.active, layer(id).prop."),
            req("map", AttrType::Enum(&["keys", "linear", "wave", "smooth", "step", "dodge", "clamp", "follow", "format"]), ""),
            a("strength", AttrType::Fraction, ""),
            a("dur", AttrType::Seconds, ""),
            a("ease", AttrType::Ease, ""),
            a("tau", AttrType::Seconds, ""),
            a("period", NON_NEG, ""),
            a("from", NUM, ""),
            a("to", NUM, ""),
