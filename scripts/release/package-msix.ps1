...
<Package
  ...
  <Identity Name="com.kanakkholwal.recast" Publisher="CN=KanakKholwal" Version="$msixVersion" ProcessorArchitecture="x64" />
  <Properties>
    <DisplayName>Recast</DisplayName>
    <PublisherDisplayName>KanakKholwal</PublisherDisplayName>
