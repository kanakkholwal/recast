<script lang="ts">
  ...
  import { clipDisplayName, pickAudioFile } from "$lib/audio/music";
  import { AudioLines, Plus, Repeat, Trash2, Volume2, VolumeX } from "@recast/icons";
  ...
  >
    ...
    {:else}
      <div class="flex flex-col gap-2.5">
        {#each store.musicClips as clip (clip.id)}
