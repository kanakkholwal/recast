...
}: { providers?: SocialProvider[]; callbackURL?: string } = $props();
...
let pending = $state<SocialProvider | null>(null);
...
{#if providers.length > 0}
	<div class="grid gap-2.5" class:grid-cols-2={providers.length > 1}>
