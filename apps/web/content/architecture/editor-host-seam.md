...
description: "How the editor became a Tauri-free package, and the two contracts the desktop host injects at startup."
position: 2
status: production
domain: editor
summary: "The editor is a portable package. The desktop app injects the native parts."
inputs:
